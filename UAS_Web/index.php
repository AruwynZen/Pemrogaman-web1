...
<body>
    ...
    <div class="container-xl">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <div class="navbar-nav mr-auto mt-lg-0">
          <a class="nav-item nav-link active text-dark" href="index.php">HOMEPAGE <span class="sr-only">(current)</span></a>
          <a class="nav-item nav-link text-dark" href="mangalist.php">MANGA LIST</a>
        </div>
        <div>
          <button type="signup" class="btn btn-light ml-auto border"><a class="text-dark" href="signup.php">SignUp</a></button>
          <button type="signin" class="btn btn-light ml-auto border"><a class="text-dark" href="login.php">SignIn</a></button>
        </div>
      </div>
    </div>
  </nav>
  ...
  <!-- Slide Bar -->
  <div class="container-xl">
    <div id="carouselExampleControls" class="carousel slide-sm ml-auto mr-auto pt-2" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="jpg/1.png" class="d-block w-100" alt="Responsive image">
        </div>
        <div class="carousel-item">
          <img src="jpg/2.png" class="d-block w-100" alt="Responsive image">
        </div>
        <div class="carousel-item">
          <img src="jpg/3.png" class="d-block w-100" alt="Responsive image">
        </div>
      </div>
  ...
  <div class="card-group container-xl">
    <div class="card mr-2">
  ...
  <div class="card-group container-xl mt-2">
    <div class="card-body card_size_r border mr-2">
    ...
    <!-- SideBar -->
    <div class="card-body card_size_l ml-auto border">
